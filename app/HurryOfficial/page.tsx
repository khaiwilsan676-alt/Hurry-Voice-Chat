...
export default function HurryOfficial() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Navbar - Black/10 kar diya aur logo curved kardi */}
      <header className="sticky top-0 z-50 flex items-center justify-between bg-black/10 backdrop-blur-md px-5 py-4 shadow-sm border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-2xl font-bold tracking-wide">Hurry</span>
        </div>
      ...
      <main className="px-4 py-12 md:px-8">
        ...
        {/* 1. Hero Section Card */}
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] border border-gray-800 bg-[#0a0a0a] p-8 md:p-16 text-center shadow-2xl">
          {/* Top Blue Glow effect like the image */}
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-600/20 blur-[70px] pointer-events-none"></div>
          
          <div className="relative z-10 flex flex-col items-center">
            {/* App logo Kisi Alag Card m nhi bss wohi logo Corner curve */}
            <Image
              src="/logo.png"
              alt="Hurry App"
              width={100}
              height={100}
              className="mb-8 h-24 w-24 object-contain rounded-3xl shadow-[0_0_30px_rgba(37,99,235,0.3)]"
            />
        ...
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] border border-gray-800 bg-[#0a0a0a] p-8 md:p-12 shadow-2xl">
          {/* Top Blue Glow effect like the image */}
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-600/15 blur-[70px] pointer-events-none"></div>
        ...
        {/* 4. Community Card */}
        <section className="mx-auto mb-16 max-w-5xl overflow-hidden relative rounded-[32px] border border-gray-800 bg-[#0a0a0a] p-8 md:p-12 shadow-2xl">
          {/* Top Blue Glow effect like the image */}
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-600/15 blur-[70px] pointer-events-none"></div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 bg-black px-6 py-10 text-center text-sm text-gray-400">
...
function SectionTitle({ title }: { title: string }) {
  return (
    <div className="mb-12 text-center">
      ...
      <div className="mx-auto h-1 w-16 rounded-full bg-blue-500/80 shadow-[0_0_10px_rgba(59,130,246,0.5)]" />
    </div>
  );
}
...
function ScreenBox({
  ...
  return (
    <div
      className={`flex shrink-0 items-center justify-center rounded-2xl border border-gray-800 bg-[#141414] text-gray-500 shadow-xl ${
...
function FeatureCard({
  ...
  return (
    <div className="rounded-3xl border border-gray-800 bg-[#141414] p-8 text-center shadow-lg transition-all hover:border-blue-500/50 hover:bg-[#1a1a1a]">
      <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-900 text-white shadow-inner border border-gray-800">
        {icon}
      </div>
