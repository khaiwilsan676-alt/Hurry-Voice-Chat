  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="px-4 py-12 md:px-8">
        ...
        {/* 1. Hero Section Card */}
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] bg-[#0a2040] p-8 md:p-16 text-center shadow-2xl">
          {/* Top Blue Glow */}
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-500/25 blur-[70px] pointer-events-none"></div>
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="max-w-xl text-lg font-light leading-relaxed text-blue-100 md:text-xl">
        ...
        {/* 2. Creative Stage Card (Alag Card) */}
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] bg-[#0a2040] p-8 md:p-12 shadow-2xl">
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-500/20 blur-[70px] pointer-events-none"></div>
          
          <div className="relative z-10 text-center md:text-left">
            {/* Heading White */}
            <h2 className="mb-4 text-3xl font-bold text-white">Creative Stage</h2>
            <p className="mb-8 text-lg font-light leading-relaxed text-blue-100">
            ...
            <div className="flex justify-center md:justify-start gap-4 overflow-x-auto pb-4">
              <ScreenBox text="App Screen 1" />
              <ScreenBox text="App Screen 2" />
            </div>
          </div>
        </section>

        {/* 3. Dynamic Socializing Card (Alag Card) */}
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] bg-[#0a2040] p-8 md:p-12 shadow-2xl">
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-500/20 blur-[70px] pointer-events-none"></div>
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-4 overflow-x-auto pb-4">
              <ScreenBox text="App Screen 3" />
              <ScreenBox text="App Screen 4" />
            </div>
          </div>
        </section>

        {/* 4. Find Your Crowd Card (Alag Card) */}
        <section className="mx-auto mb-10 max-w-5xl overflow-hidden relative rounded-[32px] bg-[#0a2040] p-8 md:p-12 shadow-2xl">
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-500/20 blur-[70px] pointer-events-none"></div>
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="mb-6 mx-auto max-w-2xl text-lg font-light leading-relaxed text-blue-100">
        ...
        {/* 6. Community Card */}
        <section className="mx-auto mb-16 max-w-5xl overflow-hidden relative rounded-[32px] bg-[#0a2040] p-8 md:p-12 shadow-2xl">
          <div className="absolute -top-40 left-1/2 h-80 w-[150%] -translate-x-1/2 rounded-[100%] bg-blue-500/20 blur-[70px] pointer-events-none"></div>
          
          <div className="relative z-10">
            <SectionTitle title="Join Our Community" />

            <p className="mb-6 text-center text-lg font-light leading-relaxed text-blue-100 md:px-10">
            ...
            <p className="mb-16 text-center text-lg font-light leading-relaxed text-blue-100 md:px-10">
...
// Yahan SectionTitle ko bhi White kar diya
...
function ScreenBox({
  ...
  return (
    <div
      className={`flex shrink-0 items-center justify-center rounded-2xl bg-black/40 text-blue-200 shadow-xl ${
...
function FeatureCard({
  ...
  return (
    <div className="rounded-3xl bg-black/30 p-8 text-center shadow-lg transition-all hover:bg-black/50">
      <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-black/60 text-blue-400 shadow-inner">
        {icon}
      </div>
      <h3 className="mb-3 text-xl font-bold text-white">{title}</h3>
      <p className="text-sm font-light text-blue-100">{text}</p>
    </div>
  );
}
