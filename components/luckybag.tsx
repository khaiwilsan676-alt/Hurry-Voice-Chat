  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center select-none">
      ...
      >
        ...
        <div className="absolute top-[100px] left-6 right-6 flex justify-between items-center z-10">
          {/* List Icon */}
        ...
        {/* ========================================= */}
        {/* BIG DARK RED CARD WRAPPER */}
        {/* ========================================= */}
        <div className="w-full bg-[#8F1616] rounded-[24px] p-5 mt-4 shadow-lg flex flex-col items-center border border-white/5">
          
          {/* Section 1: Gold Coins Count */}
          <div className="w-full flex flex-col items-center mb-1">
            <h3 className="text-white font-extrabold text-[20px] mb-3 tracking-wide drop-shadow-md">
              Gold Coins Count
            </h3>
            {/* Pill Card - Width reduced & bg-black/10 added */}
            <div className="w-[90%] bg-black/10 p-1 rounded-full flex items-center justify-between shadow-inner backdrop-blur-sm">
              {coinOptions.map((amount) => (
                <button
                  ...
                  className={`flex-1 py-2.5 text-[14px] font-bold rounded-full transition-all ${
          ...
          <div className="w-full flex flex-col items-center mt-7 mb-2">
            <h3 className="text-white font-extrabold text-[20px] mb-3 tracking-wide drop-shadow-md">
              Packets Number
            </h3>
            {/* Pill Card - Width reduced & bg-black/10 added */}
            <div className="w-[90%] bg-black/10 p-1 rounded-full flex items-center justify-between shadow-inner backdrop-blur-sm">
              {packetOptions.map((num) => (
                <button
                  ...
                  className={`flex-1 py-2.5 text-[16px] font-bold rounded-full transition-all ${
                    selectedPackets === num
                      ? 'bg-white text-[#E52E2E] shadow-md scale-100'
                      : 'text-white hover:bg-white/10 scale-95'
                  }`}
        ...
        {/* Bottom Details Row */}
        <div className="w-full flex justify-between items-center px-2 mb-5 mt-8">
          {/* Balance */}
