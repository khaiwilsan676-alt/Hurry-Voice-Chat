                    ...
                    <>
                      ...
                      <div className="flex flex-col gap-0.5 px-2.5 py-1.5 w-fit max-w-fit bg-black/20 rounded-md">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <span className="rounded-full bg-blue-500 flex items-center justify-center shrink-0" style={{ width: 'calc(var(--msg-avatar-size) * 0.72)', height: 'calc(var(--msg-avatar-size) * 0.72)' }}>
                            <svg viewBox="0 0 24 24" className="fill-white" style={{ width: 'calc(var(--msg-avatar-size) * 0.45)', height: 'calc(var(--msg-avatar-size) * 0.45)' }}>
